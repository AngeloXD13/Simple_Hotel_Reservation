...
from DATABASE_MANAGER import getAllReservationData
...
def loadallreservationdata(self):
    ...
    for item in items:
        ...
        self.reservation_tw.setItem(tableRow, 7, QtWidgets.QTableWidgetItem(str(item[13])))#room id
        self.reservation_tw.setItem(tableRow, 8, QtWidgets.QTableWidgetItem(str(item[14])))#status
        self.reservation_tw.setItem(tableRow, 1, QtWidgets.QTableWidgetItem(str(item[17])))#name
        self.reservation_tw.setItem(tableRow, 2, QtWidgets.QTableWidgetItem(str(item[18])))#address
        self.reservation_tw.setItem(tableRow, 3, QtWidgets.QTableWidgetItem(str(item[16])))#phonenumber
        tableRow = tableRow + 1
        print(tableRow)
